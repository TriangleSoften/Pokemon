      ...
      <ul class="nav navbar-nav navbar-right">
        ...
        <li class="dropdown">
          ...
          <ul class="dropdown-menu">
            <li>
              <form class="form" action="/login/attempt/" method="post" accept-charset="UTF-8">
                ...
                <div class="form-group">
                  ...
                  <div class="help-block text-right"><a href="board/index.php?action=reminder">Forget the password ?</a></div>
                </div>  
                <div class="bottom text-center">
                  New here ? <a href="board/index.php?action=register"><b>Join Us</b></a>
                </div>
                <input type="hidden" name="cookielength" value="-1" /></td>
  ...
  <form class="form-horizontal" method="post" name="submit_form" id="submit_form" action="/register/attempt/">
    ...
    <div class="form-group">        
      <div class="col-sm-offset-2 col-sm-10">
        ...
        <a href="/login?" button type="button" class="btn btn-default" value="Cancel">Cancel</a>
      </div>
    </div>
